...
from splitfed.split_model import BertClient, BertServer
from splitfed.task import load_data, train, test, get_weights
from splitfed.utils import weights_dict_to_list, weights_list_to_dict, set_model_weights
...
class FlowerClient(NumPyClient):
    ...
    def evaluate(self, parameters, config):
        ...
        return loss, len(self.valloader.dataset), {"loss": loss, "accuracy": accuracy, "f1": f1}

...
def server_fn(context: Context):
    ...
    cut_layer = 4  # Define cut_layer once and reuse
    ...
    # Model initialization for initial parameters
    ...
    # Define the custom FedAvg strategy with initial parameters
...
# Entry point for the Flower server app

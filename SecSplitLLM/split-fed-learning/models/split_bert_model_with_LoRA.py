...
# from lora.lora_utils import apply_lora
...
#         self.encoder_layers = apply_lora(nn.Sequential(*self.encoder_layers))
...
#         # Pass hidden states and attention mask as positional arguments
#         x = self.encoder_layers(x, extended_attention_mask)
